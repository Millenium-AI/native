        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
          ...
          <div className="lg:col-span-3 grid grid-cols-2 bg-native-mint-light rounded-2xl overflow-hidden">
            ...
            <div className="flex flex-col justify-center p-7">
              <Quote className="w-8 h-8 text-native-green/40 mb-4 flex-shrink-0" />
              ...
              <div>
                ...
                >
                  <p className="text-sm font-bold text-native-green group-hover:underline transition-colors">
                    Claudia Torres
                  </p>
                  <Linkedin className="w-4 h-4 text-native-green/60 group-hover:text-native-green transition-colors" />
                </a>
